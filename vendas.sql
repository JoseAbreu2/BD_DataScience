...
CREATE TABLE `item_pedido` (
  ...
  `pk_fk_pedido_id` int NOT NULL,
  `fk_produtoid` int NOT NULL,
  `quantidade` int NOT NULL,
  `preco` decimal(12,4) DEFAULT NULL,
  PRIMARY KEY (`item_pedido_id`),
  KEY `it_pd` (`pk_fk_pedido_id`),
  KEY `prod` (`fk_produtoid`),
  CONSTRAINT `it_pd` FOREIGN KEY (`pk_fk_pedido_id`) REFERENCES `pedido` (`pedido_id`),
  CONSTRAINT `prod` FOREIGN KEY (`fk_produtoid`) REFERENCES `produto` (`produto_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pedido` (
  ...
  `status_entregue` varchar(20) DEFAULT NULL,
  `status_enviado` varchar(20) DEFAULT NULL,
  `status_pendente` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`pedido_id`),
  KEY `fk_cli` (`fk_cliente_id`),
  CONSTRAINT `fk_cli` FOREIGN KEY (`fk_cliente_id`) REFERENCES `cliente` (`cliente_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-09-27 16:42:50
